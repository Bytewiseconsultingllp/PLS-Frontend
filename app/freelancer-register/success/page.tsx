  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center py-8">
      <div className="bg-white rounded-xl shadow-lg p-0 w-full max-w-2xl min-h-[600px] flex flex-col items-center">
        <div className="w-full bg-[#003087] py-8 rounded-t-xl shadow">
        ...
        <div className="p-12 w-full flex flex-col items-center flex-grow">
          <h1 className="text-4xl font-bold text-[#003087] mb-4 text-center">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-8 shadow w-full max-w-md mb-10">
            <div className="mb-4"><span className="font-semibold text-[#003087]">Name:</span> {name}</div>
            <div className="mb-4"><span className="font-semibold text-[#003087]">Email:</span> {email}</div>
            <div><span className="font-semibold text-[#003087]">Country:</span> {country}</div>
          </div>
          <a
            href="/"
            className="mt-auto px-8 py-3 rounded bg-[#003087] text-white hover:bg-blue-600 transition text-center block w-full max-w-xs"
          >
            Go to Home
          </a>
        </div>
